...
exports.StringQuoteType = void 0;
(function (StringQuoteType) {
    StringQuoteType["Single"] = "'";
    StringQuoteType["Double"] = "\"";
})(exports.StringQuoteType || (exports.StringQuoteType = {}));
 ...
 */
exports.OverpassQueryTarget = void 0;
...
})(exports.OverpassQueryTarget || (exports.OverpassQueryTarget = {}));
/** Recurse standalone statements take an input set, and produce a result set */
exports.OverpassRecurseStmType = void 0;
...
})(exports.OverpassRecurseStmType || (exports.OverpassRecurseStmType = {}));
exports.OverpassOutputVerbosity = void 0;
...
})(exports.OverpassOutputVerbosity || (exports.OverpassOutputVerbosity = {}));
exports.OverpassOutputGeoInfo = void 0;
...
})(exports.OverpassOutputGeoInfo || (exports.OverpassOutputGeoInfo = {}));
exports.OverpassSortOrder = void 0;
...
})(exports.OverpassSortOrder || (exports.OverpassSortOrder = {}));

exports.OverpassErrorType = void 0;
...
})(exports.OverpassErrorType || (exports.OverpassErrorType = {}));
class OverpassError extends Error {
    constructor(type, message, options) {
        const typeMessage = `OverpassError: ${exports.OverpassErrorType[type]}`;
...
class OverpassParameterError extends OverpassError {
    constructor(message, options) {
        super(exports.OverpassErrorType.ParameterError, message, options);
    }
}
...
exports.OverpasComparissonOperator = void 0;
...
})(exports.OverpasComparissonOperator || (exports.OverpasComparissonOperator = {}));

exports.OverpassArithmeticOperator = void 0;
...
})(exports.OverpassArithmeticOperator || (exports.OverpassArithmeticOperator = {}));

exports.OverpassFormat = void 0;
...
})(exports.OverpassFormat || (exports.OverpassFormat = {}));
exports.CSVField = void 0;
(function (CSVField) {
    /* OSM Object ID */
...
})(exports.CSVField || (exports.CSVField = {}));
...
const TARGETS$1 = {
    [exports.OverpassQueryTarget.Node]: "n",
    [exports.OverpassQueryTarget.Way]: "w",
    [exports.OverpassQueryTarget.Relation]: "r",
};
...
const OP_FORMAT = enumObjectToArray({
    [exports.OverpassFormat.XML]: "xml",
    [exports.OverpassFormat.JSON]: "json",
    [exports.OverpassFormat.JSONText]: "json",
    [exports.OverpassFormat.CSV]: "csv",
    [exports.OverpassFormat.Custom]: "custom",
    [exports.OverpassFormat.Popup]: "popup",
});
const CSV_FIELDS = {
    [exports.CSVField.Id]: "id",
    [exports.CSVField.Type]: "type",
    [exports.CSVField.OType]: "otype",
    [exports.CSVField.Latitude]: "lat",
    [exports.CSVField.Longitude]: "lon",
    [exports.CSVField.Version]: "version",
    [exports.CSVField.Timestamp]: "timestamp",
    [exports.CSVField.Changeset]: "changeset",
    [exports.CSVField.UserId]: "uid",
    [exports.CSVField.UserName]: "user",
    [exports.CSVField.Count]: "count",
    [exports.CSVField.NodeCount]: "count:nodes",
    [exports.CSVField.WayCount]: "count:ways",
    [exports.CSVField.RelationCount]: "count:relations",
    [exports.CSVField.AreaCount]: "count:areas",
};
class OverpassSettingsStatement extends OverpassStatementBase {
    ...
    static BuildSettings(settings) {
        ...
        if (settings.format == exports.OverpassFormat.CSV && settings.csvSettings == null) {
            throw new Error(`csvSettings are required when format is ${exports.OverpassFormat[exports.OverpassFormat.CSV]}`);
        }
        return new OverpassSettingsStatement(settings);
    }
    compileFormat(u) {
        if (this.settings.format != exports.OverpassFormat.CSV) {
...
const TARGETS = {
    node: exports.OverpassQueryTarget.Node,
    way: exports.OverpassQueryTarget.Way,
    relation: exports.OverpassQueryTarget.Relation,
    any: exports.OverpassQueryTarget.NodeWayRelation,
};
...
class OverpassTargetStateBase {
    ...
    isRegExpTuple(tuple) {
        const prop = tuple[0];
        return prop instanceof RegExp || (prop instanceof ParamItem && prop.isType(exports.ParamType.RegExp));
    }
    anyFilterToHelper(anyTag) {
        if (anyTag == null) {
            throw new OverpassParameterError(`Unexpected query filter value null`);
        }
        else if (typeof anyTag == "string" || (anyTag instanceof ParamItem && anyTag.isType(exports.ParamType.String))) {
            return this.tagBuilder.equals(anyTag);
        }
        else if (anyTag instanceof RegExp || (anyTag instanceof ParamItem && anyTag.isType(exports.ParamType.RegExp))) {
...
class OverpassApiObjectImp {
    ...
    async exec(settings, statementBuilder, options) {
        ...
        return this.queryValidator.validate(query, httpResponse, (_a = settings.format) !== null && _a !== void 0 ? _a : exports.OverpassFormat.XML);
    }
    execJson(statementBuilder, options, settings) {
        return this.exec({ ...settings, format: exports.OverpassFormat.JSON }, statementBuilder, options);
    }
    getUnknownFormat({ contentType }) {
        switch (contentType) {
            case "application/json":
                return exports.OverpassFormat.JSON;
            case "application/osm3s+xml":
                return exports.OverpassFormat.XML;
            case "text/csv":
                return exports.OverpassFormat.CSV;
            default:
                return undefined;
        }
    }
    ...
    createFunction(argTypes, statementBuilder, optionsInput, settingsInput) {
        ...
        const compiledQuery = this.compileParts(statements, { ...outpOptions }, { ...settings, format: exports.OverpassFormat.JSON });
        return async (...args) => {
            const query = compiledQuery.compile(args);
            const httpResponse = await this.doRequest(query);
            return this.queryValidator.validate(query, httpResponse, exports.OverpassFormat.JSON);
        };
    }
    async status() {
...
class NaiveOverpassStringSanitizer {
    sanitize(str, quote = exports.StringQuoteType.Double) {
    ...
    getValue(params) {
        if (this.value instanceof ParamItem) {
            ...
            if (params.length <= index) {
                throw new Error(`Missing parameter for [${index}](${exports.ParamType[type]}), got ${params.length} in total`);
            }
            return params[index];
        }
        else {
...
const ENUM_STRINGS = {
    [exports.ParamType.Target]: enumObjectToArray({
        [exports.OverpassQueryTarget.Node]: "node",
        [exports.OverpassQueryTarget.Way]: "way",
        [exports.OverpassQueryTarget.NodeWay]: "nw",
        [exports.OverpassQueryTarget.Relation]: "rel",
        [exports.OverpassQueryTarget.NodeRelation]: "nr",
        [exports.OverpassQueryTarget.WayRelation]: "wr",
        [exports.OverpassQueryTarget.NodeWayRelation]: "nwr",
        [exports.OverpassQueryTarget.Area]: "area",
        [exports.OverpassQueryTarget.Derived]: "derived",
    }),
    [exports.ParamType.Verbosity]: enumObjectToArray({
        [exports.OverpassOutputVerbosity.Ids]: "ids",
        [exports.OverpassOutputVerbosity.Geometry]: "skel",
        [exports.OverpassOutputVerbosity.Body]: "body",
        [exports.OverpassOutputVerbosity.Tags]: "tags",
        [exports.OverpassOutputVerbosity.Metadata]: "meta",
    }),
    [exports.ParamType.GeoInfo]: enumObjectToArray({
        [exports.OverpassOutputGeoInfo.Geometry]: "geom",
        [exports.OverpassOutputGeoInfo.BoundingBox]: "bb",
        [exports.OverpassOutputGeoInfo.Center]: "center",
    }),
    [exports.ParamType.SortOrder]: enumObjectToArray({
        [exports.OverpassSortOrder.Ascending]: "asc",
        [exports.OverpassSortOrder.QuadtileIndex]: "qt",
    }),
    [exports.ParamType.RecurseStm]: enumObjectToArray({
        [exports.OverpassRecurseStmType.Up]: "<",
        [exports.OverpassRecurseStmType.Down]: ">",
        [exports.OverpassRecurseStmType.UpRelations]: "<<",
        [exports.OverpassRecurseStmType.DownRelations]: ">>",
    }),
};
class EnumParamCompiledItem extends BaseParamCompiledItem {
    ...
    getEnumObject(type) {
        switch (type) {
            case exports.ParamType.Target:
                return exports.OverpassQueryTarget;
            case exports.ParamType.Verbosity:
                return exports.OverpassOutputVerbosity;
            case exports.ParamType.GeoInfo:
                return exports.OverpassOutputGeoInfo;
            case exports.ParamType.SortOrder:
                return exports.OverpassSortOrder;
            case exports.ParamType.RecurseStm:
                return exports.OverpassRecurseStmType;
        }
    }
    validateParam(param) {
...
class OverpassCompileUtils {
    ...
    target(value) {
        return new EnumParamCompiledItem(exports.ParamType.Target, value);
    }
    geoInfo(value) {
        return new EnumParamCompiledItem(exports.ParamType.GeoInfo, value);
    }
    sortOrder(value) {
        return new EnumParamCompiledItem(exports.ParamType.SortOrder, value);
    }
    verbosity(value) {
        return new EnumParamCompiledItem(exports.ParamType.Verbosity, value);
    }
    recurse(value) {
        return new EnumParamCompiledItem(exports.ParamType.RecurseStm, value);
    }
    regExp(value) {
...
const COMPARISSON_OPERATORS = {
    [exports.OverpasComparissonOperator.Lower]: "<",
    [exports.OverpasComparissonOperator.LowerOrEquals]: "<=",
    [exports.OverpasComparissonOperator.GreaterOrEquals]: ">=",
    [exports.OverpasComparissonOperator.Greater]: ">",
};
...
class OverpassMagnitudeEvaluatorImp extends OverpassEvaluatorImp {
    ...
    lt(right) {
        return this.compare(exports.OverpasComparissonOperator.Lower, right);
    }
    le(right) {
        return this.compare(exports.OverpasComparissonOperator.LowerOrEquals, right);
    }
    ge(right) {
        return this.compare(exports.OverpasComparissonOperator.GreaterOrEquals, right);
    }
    gt(right) {
        return this.compare(exports.OverpasComparissonOperator.Greater, right);
    }
}
...
const ARITHMETIC_OPERATORS = {
    [exports.OverpassArithmeticOperator.Add]: "+",
    [exports.OverpassArithmeticOperator.Sub]: "-",
    [exports.OverpassArithmeticOperator.Mult]: "*",
    [exports.OverpassArithmeticOperator.Divide]: "/",
};
...
class OverpassNumberEvaluatorImp extends OverpassMagnitudeEvaluatorImp {
    ...
    plus(number) {
        return this.op(exports.OverpassArithmeticOperator.Add, number);
    }
    minus(number) {
        return this.op(exports.OverpassArithmeticOperator.Sub, number);
    }
    times(number) {
        return this.op(exports.OverpassArithmeticOperator.Mult, number);
    }
    dividedBy(number) {
        return this.op(exports.OverpassArithmeticOperator.Divide, number);
    }
}
...
class OverpassRegExpTagFilter {
    ...
    getProp(u) {
        if (this.prop instanceof RegExp || (this.prop instanceof ParamItem && this.prop.isType(exports.ParamType.RegExp))) {
...
class OverpassStatusValidatorImp {
    ...
    validateStatusResponse({ status, contentType, response }) {
        if (status != 200 || !(contentType === null || contentType === void 0 ? void 0 : contentType.startsWith("text/plain"))) {
            throw new OverpassApiError(exports.OverpassErrorType.UnknownError, status, this.statusUrl, undefined, {
                cause: response,
            });
        }
    }
...
class OverpassQueryValidatorImp {
    ...
    validateHttpResponse(httpCode, overpassQuery, response, responseType) {
        if (httpCode != 200 || responseType == null) {
            ...
            switch (httpCode) {
                case 400:
                    throw new OverpassQueryError(exports.OverpassErrorType.QueryError, ...reqParams, message);
                case 429:
                    throw new OverpassQueryError(exports.OverpassErrorType.TooManyRequests, ...reqParams);
                default:
                    if (httpCode >= 500) {
                        throw new OverpassQueryError(exports.OverpassErrorType.ServerError, ...reqParams, message);
                    }
                    else {
                        throw new OverpassQueryError(exports.OverpassErrorType.UnknownError, ...reqParams, message);
                    }
            }
        }
            ...
            throw new OverpassRemarkError(type !== null && type !== void 0 ? type : exports.OverpassErrorType.QueryError, overpassQuery, errors);
        }
    }
    throwRemark(query, remark, remarks) {
        ...
        throw new OverpassRemarkError(exports.OverpassErrorType.QueryError, query, remarks);
    }
    ...
    validate(query, { status, response, contentType }, format) {
        ...
        switch (format) {
            case exports.OverpassFormat.JSON: {
                const parsed = JSON.parse(response);
                this.validateJson(query, parsed);
                return parsed;
            }
            case exports.OverpassFormat.XML: {
...
const METHOD = enumObjectToArray({
    [exports.HttpMethod.Get]: "GET",
    [exports.HttpMethod.Post]: "POST",
});
function NetworkError(error) {
    return new OverpassError(exports.OverpassErrorType.NetworkError, "Network error", { cause: error });
}
    ...
    async request(url, { method, body } = {}) {
        try {
            const response = await this.fetchFn(url, {
                method: METHOD[method !== null && method !== void 0 ? method : exports.HttpMethod.Get],
                body: body,
            });
...
class NodeHttpRequestAdapter {
    ...
    doRequest(url, { method, body }) {
        ...
        return new Promise((resolve, reject) => {
            const request = requestMethod(url, { method: METHOD[method !== null && method !== void 0 ? method : exports.HttpMethod.Get] });
...
class XMLHttpRequestAdapter {
    ...
    request(url, { method, body } = {}) {
        return new Promise((resolve, reject) => {
            ...
            request.open(METHOD[method !== null && method !== void 0 ? method : exports.HttpMethod.Get], url, true);
...
exports.DefaultOverpassApi = DefaultOverpassApi;
exports.FetchOverpassApi = FetchOverpassApi;
exports.HttpOverpassApi = HttpOverpassApi;
exports.OverpassApiError = OverpassApiError;
exports.OverpassApiObjectImp = OverpassApiObjectImp;
exports.OverpassError = OverpassError;
exports.OverpassParameterError = OverpassParameterError;
exports.OverpassQueryError = OverpassQueryError;
exports.OverpassRemarkError = OverpassRemarkError;
exports.ParamItem = ParamItem;
exports.XMLOverpassApi = XMLOverpassApi;
