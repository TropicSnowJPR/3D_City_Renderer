...
export class MapController {
    ...
    async onStart() {
        ...
        if (this.MAP.pm) {
            ...
            for (const [id, name] of Object.entries(pointJson.objects)) {
        ...
        this.MAP.on('pm:remove', (event) => {console.log("REMOVE Event: " + event)})
        ...
        function removeElementHandler(e) {
            ...
            if (event.shape === "Circle") {
                ...
                this.MAP.once('click', async (event_2) => {
                    ...
                    fetch("http://localhost:3000/api/point/", {
                        ...
                        body: JSON.stringify({
                            type: "Point",
                            GEOJSON: [event_2.latlng.lng, event_2.latlng.lat],
                            NAME: false
                        })
        ...
        function customContextMenu(e) {
            e.originalEvent.preventDefault();
            console.log("Custom context menu at " + e.latlng.toString());
        }
